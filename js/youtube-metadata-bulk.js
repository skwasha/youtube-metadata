    ...
    function handleChannelCustoms(channelCustoms, channelIds) {
        return new Promise(function (resolve) {
            ...
            function get(index) {
                ...
                $.ajax({
                    url: "https://cors-proxy-production-48a5.up.railway.app/https://www.youtube.com/" + channelCustoms[index],
                    dataType: 'html'
                }).then(function (res) {
    ...
    function handleChannelHandles(channelHandles, channelIds) {
        return new Promise(function (resolve) {
            ...
            function get(index) {
                ...
                $.ajax({
                    url: "https://cors-proxy-production-48a5.up.railway.app/https://www.youtube.com/@" + channelHandles[index],
                    dataType: 'html'
                }).then(function (res) {
                    const pageHtml = $("<div>").html(res);
            ...
            function getImageBinaryCorsProxy(fileName, imageUrl, zip, delay, imageStatuses) {
                return new Promise(function (resolve) {
                    setTimeout(function () {
                        ...
                        JSZipUtils.getBinaryContent("https://cors-proxy-production-48a5.up.railway.app/" + imageUrl, function (err, data) {
